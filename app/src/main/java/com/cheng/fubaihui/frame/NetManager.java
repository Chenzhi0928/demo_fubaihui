...
public class NetManager {
    ...
    public <T> INetService getNetService(T... t) {
        INetService service = new Retrofit.Builder()
                .baseUrl(t != null && t.length != 0 && !TextUtils.isEmpty((String) t[0]) ? (String) t[0] : Config.BASE_URL)
        ...
        leftMenuInfo.subscribeOn(Schedulers.io())
                ...
                .subscribe(new BaseObserver() {
                    ...
                    public void onSuccess(Object value) {
                        view.onSuccess(whichApi, value,(t != null && t.length != 0) ? t[0] : 0);
                    }

                    @Override
                    public void onFail(Throwable e) {
                        view.onFail(whichApi, e);
                    }
                });
    }
}
